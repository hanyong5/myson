export default [
    ...
    {
        idx:1,list:'2과',title:'하나님은 누구신가?',
        line1:'로마서 11:36상',line2:'예레미야 31:3하',
        con1:'<span>이</span>는 <span>만물</span>이 <span>주에게</span>서 나오고 <span>주</span>로 <span>말미암</span>고 <span>주에게</span>로 <span>돌아감</span>이라',
    ...
    },
    {
        ...
        line1:'요한복음 1:1',line2:'고린도후서 13:13',
    ...
    {
        idx:9,list:'10과',title:'믿음이란 무엇인가?',
    ...
    {
        idx:10,list:'11과',title:'의롭다 함을 받은 은혜',
        line1:'로마서 3장 21~22',line2:'로마서 8:32',
        con1:'이제는 율법 외에 하나님의 한 의가 나타났으니 율법과 선지자들에게 증거를 받은 것이라 곧 예수 그리스도를 믿음으로 말미암아 모든 믿는 자에게 미치는 하나님의 의니 차별이 없느니라',
        con2:'자기 아들을 아끼지 아니하시고 우리 모든 사람을 위하여 내주신 이가 어찌 그 아들과 함께 모든 것을 우리에게 주시지 아니하겠느냐'
    },
    {
        idx:11,list:'12과',title:'우리안에 계시는 성령',
        line1:'로마서 8장 26',line2:'갈라디아서 5:22~23',
        con1:'이와 같이 성령도 우리의 연약함을 도우시나니 우리는 마땅히 기도할 바를 알지 못하나 오직 성령이 말할 수 없는 탄식으로 우리를 위하여 친히 간구하시느니라',
        con2:'오직 성령의 열매는 사랑과 희락과 화평과 오래 참음과 자비와 양선과 충성과 온유와 절제니 이같은 것을 금지할 법이 없느니라'
    },
    {
        idx:11,list:'13과',title:'그리스도인의 성화',
        line1:'고린도후서 7:1',line2:'요한 1서 3:3',
        con1:'그런즉 사랑하는 자들아 이 약속을 가진 우리는 하나님을 두려워하는 가운데서 거룩함을 온전히 이루어 육과 영의 온갖 더러운 것에서 자신을 깨끗하게 하자',
        con2:'주를 향하여 이 소망을 가진 자마다 그의 깨끗하심과 같이 자기를 깨끗하게 하느니라'
    },
    {
        idx:11,list:'14과',title:'예수 그리스도의 재림',
